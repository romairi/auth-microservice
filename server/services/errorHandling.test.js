...
import {clientErrorHandler, errorHandler, logErrors, validationError} from "./errorHandling";
...
describe('errorHandling', () => {
    ...
    describe('validationError', () => {
        ...
        it('should return status code error with the object', () => {
            const err = new ValidationError(['err1', 'err2', 'err3'], {statusCode: 500});
    ...
    describe('clientErrorHandler', () => {
        ...
        it('should return INTERNAL_SERVER_ERROR', () => {
            ...
            expect(sendMock).toHaveBeenCalledWith({error: ReasonPhrases.INTERNAL_SERVER_ERROR});
            expect(nextMock).not.toHaveBeenCalled();
        });
    ...
    describe('errorHandler', () => {
        ...
        it('should return response with INTERNAL_SERVER_ERROR', () => {
            ...
            expect(resMock.status).toHaveBeenCalledWith(StatusCodes.INTERNAL_SERVER_ERROR);
            expect(resMock.send).toHaveBeenCalledWith(ReasonPhrases.INTERNAL_SERVER_ERROR);
        });
    });
});
